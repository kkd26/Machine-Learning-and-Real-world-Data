...
public class DataPreparation1 {
	 ...
	 *
	 * @param trueFile The file with file-sentiment pairings.
	 ...
	 *
	 * @param reviewsDirectory {@link Path} to the directory containing the review files.
	 * @param trueFile         {@link Path} to the file with correct file-sentiment pairings.
