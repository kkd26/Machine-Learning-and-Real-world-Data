...
import uk.ac.cam.kkd26.exercises.Exercise1;
import uk.ac.cam.kkd26.exercises.Exercise2;
import uk.ac.cam.kkd26.exercises.Exercise5;
...
public class Exercise5Tester {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("-----------------NB classifier-------------------");
		...
		System.out.println("Accuracy on the original (2004) test set:");
		...
		Map<Path, Sentiment> simplePred = impl1.simpleClassifier(testSet.keySet(), lexiconFile);
		Map<Path, Sentiment> newSimplePred = impl1.simpleClassifier(newTestSet.keySet(), lexiconFile);
		double oldSimpleAccuracy = impl1.calculateAccuracy(testSet, simplePred);
		double newSimpleAccuracy = impl1.calculateAccuracy(newTestSet, newSimplePred);

		System.out.println("Accuracy on the original (2004) test set:");
		System.out.println(oldSimpleAccuracy);
		System.out.println();

		System.out.println("Accuracy on the 2016 test set:");
		System.out.println(newSimpleAccuracy);
	}
}
