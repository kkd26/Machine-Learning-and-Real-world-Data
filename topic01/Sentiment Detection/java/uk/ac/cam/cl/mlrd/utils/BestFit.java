...
public class BestFit {
	...
	public static class Point {
		 ...
		 *
		 * @param x <code>double</code> The X coordinate
		 * @param y <code>double</code> The Y coordinate
		 */
	...
	public static class Line {
		 ...
		 *
		 * @param gradient   <code>double</code> The gradient
		 * @param yIntercept <code>double</code> The Y intercept
		 */
	 ...
	 *
	 * @param series {@link Map}<{@link Point}, {@link Double}> The points to fit,
	 *               along with a weight
