...
public interface IExercise9 {
	 ...
	 * generated them.
	 *
	 * @param sequencePairs {@link Collection}<{@link Path}> The files containing amino
	 *                      acid sequences
	 ...
	 * @param testSequencePairs A list of {@link HMMDataStore}s with observed and true hidden
	 *                          sequences.
